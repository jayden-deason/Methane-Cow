...
public class ModItems {
    ...
    public static final RegistryObject<Item> CHEESE = ITEMS.register("cheese", () ->
            new Item((new Item.Properties()).food(ModFoods.CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> SPEED_CHEESE = ITEMS.register("speed_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.SPEED_CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> SLOWNESS_CHEESE = ITEMS.register("slowness_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.SLOWNESS_CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> HASTE_CHEESE = ITEMS.register("haste_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.HASTE_CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> MINING_FATIGUE_CHEESE = ITEMS.register("mining_fatigue_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.MINING_FATIGUE_CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> STRENGTH_CHEESE = ITEMS.register("strength_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.STRENGTH_CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> INSTANT_HEALTH_CHEESE = ITEMS.register("instant_health_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.INSTANT_HEALTH_CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> INSTANT_DAMAGE_CHEESE = ITEMS.register("instant_damage_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.INSTANT_DAMAGE_CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> JUMP_BOOST_CHEESE = ITEMS.register("jump_boost_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.JUMP_BOOST_CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> NAUSEA_CHEESE = ITEMS.register("nausea_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.NAUSEA_CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> REGENERATION_CHEESE = ITEMS.register("regeneration_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.REGENERATION_CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> RESISTANCE_CHEESE = ITEMS.register("resistance_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.RESISTANCE_CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> FIRE_RESISTANCE_CHEESE = ITEMS.register("fire_resistance_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.FIRE_RESISTANCE_CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> WATER_BREATHING_CHEESE = ITEMS.register("water_breathing_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.WATER_BREATHING_CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> INVISIBILITY_CHEESE = ITEMS.register("invisibility_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.INVISIBILITY_CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> BLINDNESS_CHEESE = ITEMS.register("blindness_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.BLINDNESS_CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> NIGHT_VISION_CHEESE = ITEMS.register("night_vision_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.NIGHT_VISION_CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> HUNGER_CHEESE = ITEMS.register("hunger_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.HUNGER_CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> WEAKNESS_CHEESE = ITEMS.register("weakness_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.WEAKNESS_CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> POISON_CHEESE = ITEMS.register("poison_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.POISON_CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> WITHER_CHEESE = ITEMS.register("wither_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.WITHER_CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> SATURATION_CHEESE = ITEMS.register("saturation_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.SATURATION_CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> GLOWING_CHEESE = ITEMS.register("glowing_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.GLOWING_CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> LEVITATION_CHEESE = ITEMS.register("levitation_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.LEVITATION_CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> LUCK_CHEESE = ITEMS.register("luck_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.LUCK_CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> UNLUCK_CHEESE = ITEMS.register("unluck_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.UNLUCK_CHEESE).group(ModItemGroup.METHANECOW)));

    public static final RegistryObject<ModFoods> SLOW_FALLING_CHEESE = ITEMS.register("slow_falling_cheese", () ->
            new ModFoods((new Item.Properties()).food(ModFoods.SLOW_FALLING_CHEESE).group(ModItemGroup.METHANECOW)));
