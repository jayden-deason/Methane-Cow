package com.BoomCow.methanecow.core;
...
public class CowEntity extends AnimalEntity {
    public CowEntity(EntityType<? extends net.minecraft.entity.passive.CowEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    public net.minecraft.entity.passive.CowEntity createChild(ServerWorld world, AgeableEntity mate) {
